...
public sealed class SessionModePersistenceTests : IDisposable
{
    ...
    {
        Assert.True(_store.Save("s1", Snapshot(), "anthropic", "claude", mode: AgentModeCatalog.PlanId));
    ...
    {
        _store.Save("s2", Snapshot(), "anthropic", "claude", mode: AgentModeCatalog.BuildId);
    ...
    {
        _store.Save("s3", Snapshot(), "anthropic", "claude", mode: AgentModeCatalog.PlanId);
    ...
    {
        _store.Save("s5", Snapshot(), "anthropic", "claude", mode: AgentModeCatalog.PlanId);
    ...
    {
        _store.Save("s6", Snapshot(), "anthropic", "claude", mode: AgentModeCatalog.BuildId);
